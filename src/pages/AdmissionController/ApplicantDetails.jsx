...
export default function ApplicantDetails() {
    const { fetchApplicantDetails, updateDocumentStatus } = useContext(AppContextAPI);
    ...
    <div className="max-w-5xl mx-auto my-10 p-4 md:p-8">
      ...
      <div>
        ...
        <button
          ...
          className="ml-3 text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {docStatus === "verified"
            ? "Documents Verified"
        ...
        <div className="fixed inset-0 bg-background/50 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card w-full max-w-md border border-border p-6 rounded-lg">
            ...
            <div className="text-right">
              ...
              <button
                onClick={() => handleUpdateStatus(applicantData.documentStatus)}
